...
# Instructions:
#   1. This is a team assignment. Your team hands in one copy of R code by email.
...
#############################
# Step 2: How well associated is it between prices and the number of players?
#############################
